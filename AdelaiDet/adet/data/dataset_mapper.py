...
class DatasetMapperWithBasis(DatasetMapper):
    ...
    def __init__(self, cfg, is_train=True):
        ...
        #self.augmentation.insert(T.RandomBrightness(0.8, 1.8),
        #self.augmentation.insert(T.RandomSaturation(0.8, 1.4)
        ...
        if cfg.INPUT.CROP.ENABLED and is_train:
            ...
            self.augmentation.append(T.RandomBrightness(0.8, 1.8))
            logging.getLogger(__name__).info(
                    "Random Brightness used in training: " + str(self.augmentation[4]))
            
            self.augmentation.append(T.RandomSaturation(0.8, 1.4))
            logging.getLogger(__name__).info(
                    "Random Saturation: " + str(self.augmentation[5]))
            self.augmentation.append(T.RandomFlip(horizontal=False, vertical=True))
            logging.getLogger(__name__).info(
                    "Random Flip used in training: " + str(self.augmentation[3]))
